...
public class ChooseSpriteEnd implements CellFactory {
	...
	public Cell createSoilSurface() {
        ...
        if (chance <= 3) {
        	return new GenerateCell(new Resource(new ResourceOnMap(this.spriteStore.getSprite("default_sandstone"),"Endstone"),ToolType.NO_TOOL,1));
		}
	...
	public Cell createTrunk() {
		// TODO Auto-generated method stub
        return new GenerateCell(new Resource(new ResourceOnMap(this.spriteStore.getSprite("default_obsidian"),"Obsidian"),ToolType.NO_TOOL,1));
	}
	
	@Override
	public Cell createLeaves() {
		// TODO Auto-generated method stub
		return new GenerateCell(new Resource(new ResourceOnMap(this.spriteStore.getSprite("default_mese_crystal"),"Mese Ore"),ToolType.MEDIUM_TOOL,2));
	}
